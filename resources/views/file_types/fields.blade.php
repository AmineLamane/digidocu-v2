...
<div class="form-group col-sm-6 {{ $errors->has('file_maxsize') ? 'has-error' :'' }}">
    {!! Form::label('file_maxsize', 'Maxsize du fichier(MB):') !!}
...
<div class="form-group col-sm-12">
    {!! Form::submit('Sauvergarder', ['class' => 'btn btn-primary']) !!}
    <a href="{!! route('fileTypes.index') !!}" class="btn btn-default">Annuler</a>
</div>
